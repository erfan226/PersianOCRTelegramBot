...
def main():
    ...
    app.add_handler(
        MessageHandler(filters.Document.MimeType("image/jpeg"), handler.Photo)
    )
    app.add_handler(
        MessageHandler(filters.Document.MimeType("image/png"), handler.Photo)
    )
    app.add_handler(
        MessageHandler(filters.Document.MimeType("image/jpg"), handler.Photo)
    )
    ...
    message_handler = MessageHandler(
        filters.Document.MimeType("image/jpeg"), handler.message
    )
